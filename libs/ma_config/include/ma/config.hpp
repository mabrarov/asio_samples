...
#else // BOOST_MSVC < 1900

// MSVC 2015 and higher supports C++11 noexcept keyword
...
#endif // BOOST_MSVC < 1900

#else // defined(BOOST_MSVC) && (BOOST_MSVC >= 1500)
...
#endif // defined(BOOST_MSVC) && (BOOST_MSVC >= 1500)
