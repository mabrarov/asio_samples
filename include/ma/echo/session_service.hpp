...
#ifndef MA_ECHO_SESSION_SERVICE_HPP
#define MA_ECHO_SESSION_SERVICE_HPP
  ...
  namespace echo
  {
    ...
    public:      
      ...
      { 
        ...
        impl.reset(new impl_type(this->get_io_service()));
      ...
      { 
        // Allocate memory and construct the impl
        impl.reset(new impl_type(this->get_io_service(), arg1));
      ...
      { 
        // Allocate memory and construct the impl
        impl.reset(new impl_type(this->get_io_service(), arg1, arg2));
      ...
      { 
        // Allocate memory and construct the impl
        impl.reset(new impl_type(this->get_io_service(), arg1, arg2, arg3));
      ...
      { 
        // Allocate memory and construct the impl
        impl.reset(new impl_type(this->get_io_service(), arg1, arg2, arg3, arg4));
      ...
      { 
        // Allocate memory and construct the impl
        impl.reset(new impl_type(this->get_io_service(), arg1, arg2, arg3, arg4, arg5));
...
#endif // MA_ECHO_SESSION_SERVICE_HPP