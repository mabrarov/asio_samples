  ...
  {    
    ...
    { 
      ...
      namespace server_error
      {
        ...
        {  
          return boost::system::error_code(static_cast<int>(e), server_error_category());
        } // make_error_code

        inline boost::system::error_condition make_error_condition(error_t e)
        {  
          return boost::system::error_condition(static_cast<int>(e), server_error_category());
...
{  
  ...
  {
    template <>  
    struct is_error_code_enum<ma::echo::server::server_error::error_t> : public boost::true_type 
    {
